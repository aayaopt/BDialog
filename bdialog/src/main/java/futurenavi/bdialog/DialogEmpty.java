...
public class DialogEmpty {
    ...
    public DialogEmpty(Context context, DialogEmpty.CallBack call) {
    ...
    private void init() {
        ...
        mDialogContentView = LayoutInflater.from(mContext).inflate(R.layout.dialog_empty, null);
