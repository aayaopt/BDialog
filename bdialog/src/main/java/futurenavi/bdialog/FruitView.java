...
public class FruitView extends FrameLayout {
    ...
    private final int[] mResDrawable = {R.mipmap.ic_cat};
    ...
    LoadingView curveHeadLoadingView;
    ...
    void init(Context context) {
        View view = LayoutInflater.from(context).inflate(R.layout.widget_fruit, this);
        this.mContext = context;
        mImageView = (ImageView) view.findViewById(R.id.view_fruit_image);
        mImageView.setImageResource(mResDrawable[0]);
        curveHeadLoadingView = (LoadingView) view.findViewById(R.id.curheadloadingview);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(widthMeasureSpec, (MAX_HEIGHT + mImageView.getMeasuredHeight() +
                curveHeadLoadingView.getMeasuredHeight()));
        loadAnim();
    }
...
//                    throw new NullPointerException("please use setonViewAnimEndListener method
// before use fruitView");
